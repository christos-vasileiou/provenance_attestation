...
class Generator(torch.nn.Module):
    def __init__(self, channels):
        ...
        self.main_module = nn.Sequential(
            # Z latent vector 100
            nn.ConvTranspose1d(in_channels=100, out_channels=1024, kernel_size=4, stride=1, padding=0),
            ...
            # State (256x16x16)
            nn.ConvTranspose1d(in_channels=256, out_channels=channels, kernel_size=4, stride=2, padding=1))
...
class Discriminator(torch.nn.Module):
    def __init__(self, channels):
        ...
        self.main_module = nn.Sequential(
            # Image (Cx32x32)
            nn.Conv1d(in_channels=channels, out_channels=256, kernel_size=4, stride=2, padding=1),
            nn.BatchNorm1d(num_features=256),
